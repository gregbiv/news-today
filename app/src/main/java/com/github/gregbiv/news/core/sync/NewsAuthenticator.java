...
/**
 * Manages "Authentication" to Article' backend service.  The SyncAdapter framework
 ...
 */
public class NewsAuthenticator extends AbstractAccountAuthenticator {
    public NewsAuthenticator(Context context) {
        super(context);
    }
